...
from acp_core.runtime import RuntimeSessionInfo, RuntimeSessionSummary, TmuxRuntimeAdapter


class RuntimeAdapterProtocol(Protocol):
    def spawn_session(self, *, session_name: str, working_directory: Path, profile: str, command: str | None = None) -> RuntimeSessionInfo: ...
